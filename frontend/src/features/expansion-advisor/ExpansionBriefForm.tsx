  ...
  return (
    <form className="ea-form" onSubmit={(e) => { e.preventDefault(); onSubmit(brief); }}>
      ...
      <div className="ea-form__section">
        ...
        <div className="ea-form__row">
          <div className="ea-form__field">
            ...
            <input className="ea-form__input" value={brief.brand_name} placeholder={t("expansionAdvisor.brandNameHint")} onChange={(e) => set("brand_name", e.target.value)} />
          </div>
          <div className="ea-form__field">
            <label className="ea-form__label">{t("expansionAdvisor.category")}</label>
            <input className="ea-form__input" value={brief.category} placeholder={t("expansionAdvisor.categoryHint")} onChange={(e) => set("category", e.target.value)} />
          </div>
        </div>
        <div className="ea-form__row">
          <div className="ea-form__field">
      ...
      <div className="ea-form__section">
        ...
        <div className="ea-form__row ea-form__row--three">
          <div className="ea-form__field">
      ...
      <div className="ea-form__section">
        ...
        <div className="ea-form__field">
          ...
          <input className="ea-form__input" value={brief.target_districts.join(", ")} placeholder={t("expansionAdvisor.targetDistrictsHint")} onChange={(e) => set("target_districts", e.target.value.split(",").map((d) => d.trim()).filter(Boolean))} />
        </div>
        <div className="ea-form__row">
          <div className="ea-form__field">
      ...
      <div className="ea-form__section">
        ...
        <div className="ea-branch-list">
          ...
          {branches.length === 0 && <p className="ea-form__hint">{t("expansionAdvisor.noBranchesYet")}</p>}
          <button type="button" className="oak-btn oak-btn--sm oak-btn--tertiary" onClick={() => set("existing_branches", [...branches, { name: "", lat: 24.7136, lon: 46.6753, district: "" }])}>+ {t("expansionAdvisor.addBranch")}</button>
        </div>
      </div>
      ...
      <button type="submit" className="oak-btn oak-btn--primary ea-form__submit" disabled={loading || !brief.brand_name}>{loading ? t("expansionAdvisor.loadingSearch") : t("expansionAdvisor.runSearch")}</button>
    </form>
  );
}
