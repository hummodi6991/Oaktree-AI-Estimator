  ...
  return (
    <form className="ea-form" onSubmit={(e) => { e.preventDefault(); onSubmit(brief); }}>
      ...
      <div className="ea-form__section">
        <div className="ea-form__section-header">
          <span className="ea-form__step-number">1</span>
          <h4 className="ea-form__section-title">{t("expansionAdvisor.brandBasics")}</h4>
        </div>
        <p className="ea-form__helper">{t("expansionAdvisor.brandBasicsHelper")}</p>
        <div className="ea-form__row">
          <div className="ea-form__field">
            <label className="ea-form__label">{t("expansionAdvisor.brandName")}</label>
            <input className="ea-form__input" value={brief.brand_name} placeholder={t("expansionAdvisor.brandNamePlaceholder")} onChange={(e) => set("brand_name", e.target.value)} />
          </div>
          <div className="ea-form__field">
            <label className="ea-form__label">{t("expansionAdvisor.category")}</label>
            <input className="ea-form__input" value={brief.category} placeholder={t("expansionAdvisor.categoryPlaceholder")} onChange={(e) => set("category", e.target.value)} />
          </div>
        </div>
        <div className="ea-form__row">
          <div className="ea-form__field">
        ...
        <div className="ea-form__row">
          ...
          <div className="ea-form__field">
            ...
            <input className="ea-form__input" value={brief.brand_profile?.target_customer ?? ""} placeholder={t("expansionAdvisor.targetCustomerPlaceholder")} onChange={(e) => setProfile("target_customer", e.target.value || null)} />
          </div>
        </div>
      </div>

      {/* Step 2: Unit requirements */}
      <div className="ea-form__section">
        <div className="ea-form__section-header">
          <span className="ea-form__step-number">2</span>
          <h4 className="ea-form__section-title">{t("expansionAdvisor.unitSizing")}</h4>
        </div>
        <p className="ea-form__helper">{t("expansionAdvisor.unitSizingHelper")}</p>
        <div className="ea-form__row">
          <div className="ea-form__field">
      ...
      <div className="ea-form__section">
        <div className="ea-form__section-header">
          <span className="ea-form__step-number">3</span>
          <h4 className="ea-form__section-title">{t("expansionAdvisor.geography")}</h4>
        </div>
        <p className="ea-form__helper">{t("expansionAdvisor.geographyHelper")}</p>
        <div className="ea-form__field">
          <label className="ea-form__label">{t("expansionAdvisor.targetDistricts")}</label>
          <input className="ea-form__input" value={brief.target_districts.join(", ")} placeholder={t("expansionAdvisor.targetDistrictsPlaceholder")} onChange={(e) => set("target_districts", e.target.value.split(",").map((d) => d.trim()).filter(Boolean))} />
        </div>
        <div className="ea-form__row">
          <div className="ea-form__field">
            <label className="ea-form__label">{t("expansionAdvisor.preferredDistricts")}</label>
            <input className="ea-form__input" value={(brief.brand_profile?.preferred_districts || []).join(", ")} placeholder={t("expansionAdvisor.preferredDistrictsPlaceholder")} onChange={(e) => setProfile("preferred_districts", e.target.value.split(",").map((d) => d.trim()).filter(Boolean))} />
          </div>
          <div className="ea-form__field">
            <label className="ea-form__label">{t("expansionAdvisor.excludedDistricts")}</label>
            <input className="ea-form__input" value={(brief.brand_profile?.excluded_districts || []).join(", ")} placeholder={t("expansionAdvisor.excludedDistrictsPlaceholder")} onChange={(e) => setProfile("excluded_districts", e.target.value.split(",").map((d) => d.trim()).filter(Boolean))} />
          </div>
        </div>
      </div>

      {/* Step 4: Existing branches */}
      <div className="ea-form__section">
        <div className="ea-form__section-header">
          <span className="ea-form__step-number">4</span>
          <h4 className="ea-form__section-title">{t("expansionAdvisor.existingBranchesLabel")}</h4>
        </div>
        <p className="ea-form__helper">{t("expansionAdvisor.existingBranchesHelper")}</p>
      ...
      <div className="ea-form__section">
        <div className="ea-form__section-header">
          <span className="ea-form__step-number">5</span>
          <h4 className="ea-form__section-title">{t("expansionAdvisor.brandPreferences")}</h4>
        </div>
        <p className="ea-form__helper">{t("expansionAdvisor.brandPreferencesHelper")}</p>
        <div className="ea-form__row">
          <div className="ea-form__field">
        ...
        <div className="ea-form__row">
          ...
          <div className="ea-form__field">
            ...
            <input className="ea-form__input" type="number" value={brief.brand_profile?.cannibalization_tolerance_m ?? ""} placeholder="1500" onChange={(e) => setProfile("cannibalization_tolerance_m", Number(e.target.value) || null)} />
          </div>
        </div>
        <div className="ea-form__field">
      ...
      <button type="submit" className="oak-btn oak-btn--primary ea-form__submit" disabled={loading || !brief.brand_name}>{loading ? t("expansionAdvisor.loadingSearch") : t("expansionAdvisor.runSearchCta")}</button>
    </form>
  );
}
