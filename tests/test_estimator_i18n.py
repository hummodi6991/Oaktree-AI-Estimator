...
EXPECTED_EN = {
    ...
    # Income-component keys: EN = humanized key (str(key).replace("_", " ")).
    "income_component.residential": "residential",
    "income_component.retail": "retail",
    "income_component.office": "office",
    "income_component.commercial": "commercial",
    "income_component.parking_income": "parking income",
    # Assumption keys: EN = raw key (current PDF behavior).
    "assumption.land_price": "land_price",
    "assumption.rent_rate": "rent_rate",
    "assumption.excel_method": "excel_method",
    "assumption.site_area_m2": "site_area_m2",
    "assumption.ppm2": "ppm2",
    "assumption.real_estate_price_index_scalar": "real_estate_price_index_scalar",
    "assumption.parking_required_spaces": "parking_required_spaces",
    "assumption.parking_provided_spaces": "parking_provided_spaces",
    "assumption.parking_supply_gross_m2_per_space": "parking_supply_gross_m2_per_space",
    "assumption.parking_supply_layout_efficiency": "parking_supply_layout_efficiency",
    "assumption.avg_unit_size_residential_m2": "avg_unit_size_residential_m2",
    "assumption.avg_unit_size_retail_m2": "avg_unit_size_retail_m2",
    "assumption.avg_unit_size_office_m2": "avg_unit_size_office_m2",
    "assumption.sale_price_per_m2": "sale_price_per_m2",
    "assumption.rent_per_m2": "rent_per_m2",
    "assumption.avg_unit_m2": "avg_unit_m2",
    "assumption.occ": "occ",
    "assumption.op_ex_ratio": "op_ex_ratio",
    "assumption.cap_rate": "cap_rate",
    "assumption.parking_extra_spaces_monetized": "parking_extra_spaces_monetized",
    "assumption.parking_monthly_rate_sar_per_space": "parking_monthly_rate_sar_per_space",
    "assumption.parking_occupancy": "parking_occupancy",
    "assumption.parking_public_access": "parking_public_access",
    "assumption.parking_income_y1": "parking_income_y1",
}
